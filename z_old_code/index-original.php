...
//run the query
$result = $mysqli->query("SELECT * FROM songsnycindub WHERE 1 ORDER BY currentdate DESC LIMIT 3");
          ...
          <div class="home-category-header"><a href="songs.php"><h3>Songs</h3></a></div>
             ...
             <div class="side-div">
                <div class="audio-description-div">
                  ...
                  <a href="songs.php"><div class="button"><span class="button-text"><p class="button-text-p">More Music</p></span></div></a>
                </div>
             </div>
