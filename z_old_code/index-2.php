...
<!-- End Header -->
      ...
      <div id="main-site-div"> <!-- BEGIN BODY DIV -->
        ...
        <div class="carousel-large"> <!-- BEGIN CAROUSEL -->
          ...
          <div><a href="showsandevents.php" title="285 Kent"><img src="images/carousel/285kent1.jpg" /><div class="carousel-overlay"><p>Check out our exclusive photos from famed Williamsburg event space, 285 Kent.</p></div></a></div>
          <div><a href="features.php" title="East Village Radio"><img src="images/carousel/evr.jpg" /><div class="carousel-overlay"><p>Meet the cast of characters behind NYC's East Village Radio</p></div></a></div>
          <div><a href="features.php" title="Innergaze on Minimal Wave Records"><img src="images/carousel/innergazephoto.jpg" /><div class="carousel-overlay"><p>“Innergaze drag us slightly further back into the glorious cradle of dance music."</p></div></a></div>
          <div><a href="showsandevents.php" title="285 Kent"><img src="images/carousel/285kent2.jpg" /><div class="carousel-overlay"><p>Check out our exclusive photos from famed Williamsburg event space, 285 Kent.</p></div></a></div>
          <div><a href="features.php" title="Williamsburg's Rough Trade"><img src="images/carousel/roughtrade.jpg" /><div class="carousel-overlay"><p>Say hello to Brooklyn's newest (and biggest) record shop: Rough Trade NYC</p></div></a></div>
          <div><a href="showsandevents.php" title="285 Kent"><img src="images/carousel/285kent3.jpg" /><div class="carousel-overlay"><p>Check out our exclusive photos from famed Williamsburg event space, 285 Kent.</p></div></a></div>
          ...
          <div class="home-category-header"><a href="features.php"><h3>Features</h3></a></div>
            ...
            <div class="main-div">
              <div class="home-category-content-textbox">
                ...
                <a href="features.php"><div class="button"><span class="button-text"><p class="button-text-p">Read More</p></span></div></a></p>
              </div>
            </div>
        ...
        <article class="home-category" id="home-reviews">
          ...
          <div class="side-div">
            <div class="featured-reviews-div">
              ...
              <p>Armand Van Helden and A-Trak have spent a large part of this decade acting as big-box dance music's merry pranksters, following their clown-nosed muses to the most illogically comical endpoints.</p>
              <p>Minimal Wave's Cititrax sub-label introduces the no wave techno styles of Douglas Lee's An-i alias.</p>
            </div>
          ...
          <!-- Main Reviews (large image w/caption) -->
          <figure>
            <a href="reviews.php">
          ...
          <figure>
            <a href="reviews.php">
              <img class="review-img" src="images/reviews/kelis.jpg" />
              <figcaption><h4>Kelis</h4><p>Food</p></figcaption>
            </a>
          </figure>

          <figure>
            <a href="reviews.php">
              <img class="review-img" src="images/reviews/Nas-Illmatic.jpg" />
              <figcaption><h4>Nas</h4><p>Illmatic XX</p></figcaption>
            </a>
          </figure>

          <figure>
            <a href="reviews.php">
              <img class="review-img" src="images/reviews/lcd.jpg" />
              <figcaption><h4>LCD Soundsystem</h4><p>The Long Goodbye</p></figcaption>
            </a>
          </figure>

          <figure>
            <a href="reviews.php">
              <img class="review-img" src="images/reviews/Life_Without_Buildings.jpg" />
              <figcaption><h4>Life Without Buildings</h4><p>Any Other City</p></figcaption>
            </a>
          </figure>
          ...
          <div class="home-category-header"><a href="songs.php"><h3>Songs</h3></a></div>
             ...
             <div class="side-div">
                <div class="audio-description-div">
                  <h1>THIS WEEK'S FEATURED TRACK REVIEWS</h1>
                  <p class="audio-p"><strong>NGLY "Service Cost HH2": </strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec a diam lectus.</br><a href="songs.php">More</a></p>
                  <p class="audio-p"><strong>Maria Minerva "The Beginning": </strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec a diam lectus.</br><a href="songs.php">More</a></p>
                  <p class="audio-p"><strong>EX.194 Veronica Vasicka: </strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec a diam lectus.</br><a href="songs.php">More</a></p>
                  <a href="artists.php"><div class="button"><span class="button-text"><p class="button-text-p">More Music</p></span></div></a>
                </div>
             </div>

             <div class="main-div" id="soundcloud-div">
                <iframe width="100%" height="100" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/142503357&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_artwork=true"></iframe>
                <iframe width="100%" height="100" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/140750879&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_artwork=true"></iframe>
                <iframe width="100%" height="100" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/144044535&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_artwork=true"></iframe>
             </div>
            ...
            <div class="shows-content"> <!-- Begin "Shows and Events" Main Content DIV -->
              ...
              <div class="shows-content-box" id="bass">
                ...
                <div class="shows-copy-container">
                  ...
                  <a href="showsandevents.php"><div class="button"><span class="button-text"><p class="button-text-p">Read More</p></span></div></a>
                </p>
